  ...
  return (
    <main>
      ...
      <section className="about-section" id="nosotros">
        ...
        <div className="about-grid"><h2>{english ? <>Beauty should be a<br /><em>moment of care.</em></> : <>La belleza tambien es<br /><em>un momento de cuidado.</em></>}</h2><div><p>{english ? 'CosmeticLAB is a beauty company created to make makeup and skincare feel more intentional, approachable and joyful. We choose formulas that respect your skin and products that fit naturally into your routine.' : 'CosmeticLAB es una empresa de belleza creada para hacer del maquillaje y el cuidado de la piel una experiencia mas consciente, cercana y alegre. Elegimos formulas que respetan tu piel y productos que se integran naturalmente a tu rutina.'}</p><Link to="/productos" className="text-link">{english ? 'Discover our products →' : 'Conoce nuestros productos →'}</Link></div></div>
      </section>
      ...
      <section className="contact-section" id="contacto">
        ...
        <div className="contact-details"><a href="mailto:hola@cosmeticlab.com">hola@cosmeticlab.com</a><a href="tel:+573001234567">+57 300 123 4567</a><span>{english ? 'Mon–Fri · 9:00–18:00' : 'Lun–Vie · 9:00–18:00'}</span></div>
      </section>
    </main>
  );
};
